...
# =============================================================================
# Script de Personalização de Módulos e Configurações Dolibarr
# Ativa módulos, define permissões, numeração e configurações
# =============================================================================
...
echo "============================================"
echo "PERSONALIZANDO MÓDULOS E CONFIGURAÇÕES"
echo "============================================"
...
-- ============================================
-- PERMISSÕES - Societe (terceiros/contatos)
-- ============================================
...
-- ============================================
INSERT IGNORE INTO llx_rights_def (id, entity, libelle, module, module_position, family, type, bydefault, perms, subperms, enabled) VALUES
(2401, 1, 'Read actions of others', 'agenda', 10, 'technic', 'r', 0, 'allactions', NULL, '1'),
(2402, 1, 'Read actions of others', 'agenda', 10, 'technic', 'r', 0, 'allactions', NULL, '1'),
(2411, 1, 'Read all actions', 'agenda', 10, 'technic', 'r', 0, 'allactions', NULL, '1'),
(2412, 1, 'Read all actions', 'agenda', 10, 'technic', 'r', 0, 'allactions', NULL, '1'),
...
echo "24 módulos ativados, permissões concedidas ao admin"
echo "============================================"
echo ""