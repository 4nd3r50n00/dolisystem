...
$theme_bgcolor = array(hexdec('18'), hexdec('18'), hexdec('18'));
$theme_bgcoloronglet = array(hexdec('20'), hexdec('20'), hexdec('20'));

// Colors
$colorbackbody = '18,18,18';
$colorbackhmenu1 = '28,28,30'; // topmenu
//$colorbackvmenu1 = '250,250,250'; // vmenu
$colorbackvmenu1 = '28,28,30'; // vmenu
$colortopbordertitle1 = '40,40,42'; // top border of title
$colorbacktitle1 = '24,24,26'; // title of tables,list
$colorbacktabcard1 = '28,28,30'; // card
$colorbacktabactive = '40,40,42';
$colorbacklineimpair1 = '24,24,26'; // line impair
$colorbacklineimpair2 = '24,24,26'; // line impair
$colorbacklinepair1 = '28,28,30'; // line pair
$colorbacklinepair2 = '28,28,30'; // line pair
$colorbacklinepairhover = '40,40,42'; // line hover
$colorbacklinepairchecked = '50,50,55'; // line checked
$colorbacklinebreak = '24,24,26'; // line break
$colortexttitlenotab = '52, 211, 153'; // 150,90,121 140,80,10 or 10,140,80  #875a7b  green=0,123,140, violet: 0,50,120
$colortexttitlenotab2 = '52, 211, 153'; // 150,90,121 140,80,10 or 10,140,80  #875a7b  green=0,123,140, violet: 0,50,120
$colortexttitle = '220, 220, 225';
$colortexttitlelink = '52, 211, 153';
$colortext = '210,210,210';
$colortextlink = '52, 211, 153';
$fontsize = '0.94em';
$fontsizesmaller = '0.75em';
$topMenuFontSize = '1.1em';
$toolTipBgColor = 'rgba(40, 40, 42, 0.96)';
$toolTipFontColor = '#eeeeee';
$butactionbg = '16, 185, 129';
