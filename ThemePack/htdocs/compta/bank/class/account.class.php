...
class Account extends CommonObject
{
	...
	public $fields = array(
		...
		'tipo_chave_pix' => array('type' => 'varchar(20)', 'label' => 'TipoChavePix', 'enabled' => 1, 'visible' => -1, 'position' => 186),
		'chave_pix' => array('type' => 'varchar(100)', 'label' => 'ChavePix', 'enabled' => 1, 'visible' => -1, 'position' => 187),
	);
	...
	public function create($user, $notrigger = 0)
	{
		...
		$sql .= ", '".$this->db->escape($this->tipo_chave_pix)."'";
		$sql .= ", '".$this->db->escape($this->chave_pix)."'";
		$sql .= ")";
	...
	public function update($user, $notrigger = 0)
	{
		...
		$sql .= ",tipo_chave_pix = '".$this->db->escape($this->tipo_chave_pix)."'";
		$sql .= ",chave_pix = '".$this->db->escape($this->chave_pix)."'";
	...
	public function fetch($id, $ref = '')
	{
		...
		$sql .= " ba.datec as date_creation, ba.tms as date_modification, ba.ics, ba.ics_transfer, ba.tipo_chave_pix, ba.chave_pix,";
