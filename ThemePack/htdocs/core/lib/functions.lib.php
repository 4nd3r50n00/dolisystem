...
$currencyIconMap = array(
	...
	$icon = isset($currencyIconMap[$conf->currency]) ? $currencyIconMap[$conf->currency] : 'dollar-sign';
	$arrayconvpictotofa['currency'] = $icon;
	$arrayconvpictotofa['multicurrency'] = 'coins';
	} else {
		$arrayconvpictotofa = array();
	}
