...
/**
 *	\file       htdocs/core/modules/commande/doc/pdf_master_order.modules.php
 *	\ingroup    order
 *	\brief      File of Class to generate PDF orders with template master_order
 */
...
/**
 *	Class to generate PDF orders with template master_order
 */
class pdf_master_order extends ModelePDFCommandes
{
	/**
	...
	public function __construct(DoliDB $db)
	{
		...
		$this->db = $db;
		$this->name = "MasterOrder";
		$this->description = 'Modelo Master Order - By Anderson';
