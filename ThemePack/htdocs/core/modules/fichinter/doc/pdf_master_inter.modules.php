...
/**
 *	\file       htdocs/core/modules/fichinter/doc/pdf_master_inter.modules.php
 *	\ingroup    ficheinter
 *	\brief      File of Class to build interventions documents with model master_inter
 */
...
/**
 *	Class to build interventions documents with model master_inter
 */
class pdf_master_inter extends ModelePDFFicheinter
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = 'MasterInter';
		$this->description = 'Modelo Master Inter - By Anderson';
	...
	protected function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop = 0, $hidebottom = 0, $object = null)
	{
		...
		*/
		...
		if (empty($hidebottom)) {
			// --- Dimensions matching proposal style but positioned around native onlineSign stamp ---
			// onlineSign natively stamps at X=65, Y=242, W=80.
			// Center of page is 105. Center of stamp is 105.
			// Box W=112, centered => X=49. Box Y=235, H=40 => spans Y=235 to Y=275. 
			// Stamp Y=242 falls perfectly inside the box!
			$box_width  = 112; 
			$box_height = 40;  
			$posx_sig   = ($this->page_largeur - $box_width) / 2; // 49
			$box_y      = 235; 
