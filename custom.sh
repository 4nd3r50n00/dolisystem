...
-- Criar tabelas do módulo de Contabilidade (BookKeeping)
...
fk_doc INTEGER DEFAULT NULL,
fk_docdet INTEGER DEFAULT NULL,
fk_user_author INTEGER DEFAULT NULL,
import_key VARCHAR(14) DEFAULT NULL,
code_client VARCHAR(255) DEFAULT NULL,
subcode VARCHAR(255) DEFAULT NULL,
sens INTEGER DEFAULT NULL,
fk_account INTEGER NOT NULL,
fk_account_aux INTEGER DEFAULT NULL,
...
numero_tiers VARCHAR(255) DEFAULT NULL,
label_tiers VARCHAR(255) DEFAULT NULL,
...
fk_user_reconcile INTEGER DEFAULT NULL,
lineid INTEGER DEFAULT NULL,
fk_bank INTEGER DEFAULT NULL,
fk_typeaccount INTEGER DEFAULT NULL,
fk_accountancy_accounting_journal INTEGER DEFAULT NULL,
piece_num VARCHAR(255) DEFAULT NULL,
note_public TEXT DEFAULT NULL,
code_journal VARCHAR(255) DEFAULT NULL,
fk_vat INTEGER DEFAULT NULL,
situation_percent DOUBLE DEFAULT NULL,
debut_reliquat DATE DEFAULT NULL,
total_ttc DOUBLE DEFAULT NULL,
mode_label VARCHAR(255) DEFAULT NULL,
origin_lineid INTEGER DEFAULT NULL,
multicurrency_amount DOUBLE(24,8) DEFAULT NULL,
multicurrency_code VARCHAR(255) DEFAULT NULL,
KEY idx_accounting_bookkeeping_rowid (rowid),
KEY idx_accounting_bookkeeping_fk_doc (fk_doc),
KEY idx_accounting_bookkeeping_fk_account (fk_account),
KEY idx_accounting_bookkeeping_doc_type (doc_type),
KEY idx_accounting_bookkeeping_fk_accountancy_accounting_journal (fk_accountancy_accounting_journal),
KEY idx_accounting_bookkeeping_journal_code (journal_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
multicurrency_amount DOUBLE(24,8) DEFAULT NULL,
multicurrency_code VARCHAR(255) DEFAULT NULL,
KEY idx_accounting_bookkeeping_tmp_rowid (rowid),
KEY idx_accounting_bookkeeping_tmp_fk_doc (fk_doc),
KEY idx_accounting_bookkeeping_tmp_fk_account (fk_account),
KEY idx_accounting_bookkeeping_tmp_piece_num (piece_num),
KEY idx_accounting_bookkeeping_tmp_entity (entity)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
