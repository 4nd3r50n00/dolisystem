...
fk_doc INTEGER DEFAULT 0,
fk_docdet INTEGER DEFAULT 0,
thirdparty_code VARCHAR(255) DEFAULT NULL,
...
date_lettering DATE DEFAULT NULL,
...
KEY idx_accounting_bookkeeping_piece_num (piece_num),
KEY idx_accounting_bookkeeping_entity (entity),
KEY idx_accounting_bookkeeping_code_journal (code_journal),
KEY idx_accounting_bookkeeping_lettering_code (lettering_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
