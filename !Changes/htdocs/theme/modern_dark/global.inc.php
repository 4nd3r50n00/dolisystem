...
.formconsumeproduce {
	border-left: solid 5px var(--primarycolor, #4390dc);
...
.select2-container--default .select2-results__option--highlighted[aria-selected] {
	background-color: var(--colorbackvmenu1) !important;
...
/* ============================================================================== */
/* Modern Dark Theme Enhancements overrides                                       */
/* ============================================================================== */

body, select, input, textarea, button, p, td, th {
...
.button, .butAction, .butActionDelete, .butActionNew {
...
.tabBar {
    ...
    background-color: var(--colorbacktabcard1) !important;
    border: 1px solid rgba(255, 255, 255, 0.05) !important;
...
.tabactive, div.tabactive, a.tabactive {
...
.tabunactive, div.tabunactive, a.tabunactive {
    border-radius: 8px 8px 0 0 !important;
    background-color: var(--colorbacktitle1) !important;
    border: 1px solid rgba(255, 255, 255, 0.05) !important;
    border-bottom: none !important;
...
/* Adjust width for line creation inputs */
#price_ht, #price_ttc, .linecoldiscount input, #qty {
}
