...
$theme = 'modern_dark'; // Value of theme
...
$fontlist = '"Inter", arial,tahoma,verdana,helvetica';
...
print "@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap');\n";
print '/*'."\n";
